...
class ConversationService {
   ...
   */
  static loadConversation(userId: string): Message[] {
    try {
   ...
   */
  static saveConversation(userId: string, messages: Message[]): void {
    try {
      const key = `chat-${userId}`;
   ...
   */
  static getConversationId(userId: string): string | null {
    try {
   ...
   */
  static saveConversationId(userId: string, conversationId: string): void {
    try {
      const key = `conversation-${userId}`;

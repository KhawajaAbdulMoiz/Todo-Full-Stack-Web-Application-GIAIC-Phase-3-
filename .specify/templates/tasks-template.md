...
- [ ] T006 [P] Setup API routing and middleware structure (FastAPI)
- [ ] T007 Create base models/entities that all stories depend on (SQLModel)
- [ ] T008 Configure error handling and logging infrastructure
- [ ] T009 Setup environment configuration management (no hardcoded secrets)

**Constitution Compliance Check**:
- [ ] Verify Next.js 16+ App Router + OpenAI ChatKit stack is used (no other frontend frameworks)
- [ ] Verify Python FastAPI is used (no other backend frameworks)
- [ ] Verify OpenAI Agents SDK is used (no other AI frameworks)
- [ ] Verify Official MCP SDK is used (no other MCP implementations)
- [ ] Verify SQLModel is used (no other ORMs)
- [ ] Verify Neon Serverless PostgreSQL is used (no other databases)
- [ ] Verify Better Auth (JWT) is used (no other auth systems)
- [ ] Verify no manual coding - all via AI agents using MCP tools
...
**Security Check**:
- [ ] Verify all API and chat endpoints enforce authentication and user ownership
- [ ] Verify JWT verification is required on all API and chat endpoints
...
- [ ] Verify user data isolation is enforced at API, tool, and database layers
...
- [ ] Verify clear separation of frontend, backend, agent, and MCP layers
- [ ] Verify consistent JSON request/response formats
...
- [ ] Verify no unused endpoints, tools, or models
- [ ] Verify RESTful API conventions are followed consistently
- [ ] Verify database schema changes are traceable and version-safe
- [ ] Verify frontend never bypasses backend or MCP layers
- [ ] Verify all API and chat endpoints require valid JWT after authentication is enabled
